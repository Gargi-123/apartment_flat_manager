...
export const getSingleFlatRequest = (payload) => async (dispatch) => {
  ...
  return await fetch(
    `http://localhost:5000/api/apartment/getFlatData/${payload.flat_id}`,
    {
      method: "GET",
      headers: {
        "Content-type": "application/json",
...
export const addFlatRequest = (payload) => (dispatch) => {
  ...
  return fetch("http://localhost:5000/api/apartment/addFlat", {
    method: "POST",
    headers: {
      "Content-type": "application/json",
    },
...
export const editFlatRequest = (payload) => (dispatch) => {
  ...
  return fetch("http://localhost:5000/api/apartment/editFlatData", {
    method: "POST",
    headers: {
      "Content-type": "application/json",
    },
...
export const deleteFlatRequest = (payload) => (dispatch) => {
  ...
  return fetch("http://localhost:5000/api/apartment/deleteFlat", {
    method: "DELETE",
    headers: {
      "Content-type": "application/json",
    },
...
export const deleteFlatResidentRequest = (payload) => (dispatch) => {
  ...
  return fetch("http://localhost:5000/api/apartment/deleteResident", {
    method: "DELETE",
    headers: {
      "Content-type": "application/json",
    },
